        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 flex justify-between">
                    <div class="">
                        <h2 class="font-semibold text-xl dark:text-white mb-1">Semua Laporan</h2>
                        <span class="dark:text-gray-300"> Data semua laporan, </span> <br>
                                ...
                                @foreach ($data as $item)
                                    <tr class="border border-collapse border-x-0 border-gray-300">
                                        <td class="py-2 px-4 dark:text-gray-300 uppercase text-xs">
                                            <a
                                                href="{{route('admin.laporan.detail', $item->id)}}">{{$item->judul_laporan}}</a>
                                        </td>
